...
namespace HRIS_Common
{
	...
	class CommonDB
	{
		...
		const string connectstring_RCT = "HRIS_RCT";
		...
		public SqlConnection ConnectDB()
		{
			try
			{
				string ConnectString = ConfigurationManager.ConnectionStrings[connectstring_RCT].ConnectionString;
				SqlConnection conn;
        ...
        // Date Created :   09/07/2018
        //****************************************************************
        public SqlConnection ConnectDBAPL()
        {
            try
            {
                string ConnectString = ConfigurationManager.ConnectionStrings["HRIS_APL"].ConnectionString;
                SqlConnection conn;
                conn = new SqlConnection(ConnectString);
                return conn;
            }
        ...
        // Date Created :   09/07/2018
        //*********************************************************************************
        public DataTable GetDatatableAPL(string selectstring)
        {
            SqlConnection con;
            DataTable dt = new DataTable();
            DataSet ds = new DataSet();
		...
		public DataTable RetrieveData(string sp_script)
		{
			...
			{
				DataTable dt = new DataTable();
				string connStr = System.Configuration.ConfigurationManager.ConnectionStrings[connectstring_RCT].ConnectionString;
