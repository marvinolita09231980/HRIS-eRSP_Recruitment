! function (a) {
    ...
    var c = {
        ...
        t = function () {
            ...
            b = {
                picture: function (a) {
                    return '<button type="button" class="btn btn-default btn-sm btn-small hidden" title="' + a.image.image + '" data-event="showImageDialog" tabindex="-1"><i class="fa fa-picture-o icon-picture"></i></button>'
                },
                link: function (a) {
            ...
            g = function (a, b) {
                var d = function () {
                    return '<div class="note-image-dialog modal" aria-hidden="false"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-hidden="true" tabindex="-1">&times;</button><h4>' + a.image.insert + '</h4></div><div class="modal-body"><div class="row-fluid"><h5>' + a.image.selectFromFiles + '</h5><input class="note-image-input emailattached" id="emailattached" type="file" name="files" accept="image/*" /><h5>' + a.image.url + '</h5><input class="note-image-url form-control span12" type="text" /></div></div><div class="modal-footer"><button href="#" class="btn btn-primary note-image-btn addattachedfile" id="addattachedfile" >' + a.image.insert + "</button></div></div></div></div>"
                },
                    e = function () {
            ...
            this.createLayout = function (c, i) {
                ...
                if (!j || !j.hasClass("note-editor")) {
                    ...
                    var l = !c.is(":disabled"),
                        m = a('<div class="note-editable" id="mail-content" contentEditable="' + l + '"></div>').prependTo(k);
