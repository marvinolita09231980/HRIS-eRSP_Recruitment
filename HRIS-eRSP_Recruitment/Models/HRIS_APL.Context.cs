...
namespace HRIS_eRSP_Recruitment.Models
{
    ...
    public partial class HRIS_APLEntities : DbContext
    {
        ...
        public virtual DbSet<VW_available_item_hdr_tbl_distinct> VW_available_item_hdr_tbl_distinct { get; set; }
        public virtual DbSet<onlineAppliedItem_tbl> onlineAppliedItem_tbl { get; set; }
        public virtual DbSet<vw_applieditems_tbl> vw_applieditems_tbl { get; set; }
